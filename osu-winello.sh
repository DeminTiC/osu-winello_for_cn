...
# Wine-osu mirror
WINELINK="https://cdn.gh-proxy.org/https://github.com/NelloKudo/WineBuilder/releases/download/wine-osu-staging-${WINEVERSION}/wine-osu-winello-fonts-wow64-${WINEVERSION}-x86_64.tar.xz"
WINECACHYLINK="https://cdn.gh-proxy.org/https://github.com/NelloKudo/WineBuilder/releases/download/wine-osu-cachyos-v10.0-3/wine-osu-cachy-winello-fonts-wow64-10.0-3-x86_64.tar.xz"
...
WINETRICKSLINK="https://cdn.gh-proxy.org/https://raw.githubusercontent.com/Winetricks/winetricks/master/src/winetricks"                 # Winetricks for --fixprefix
PREFIXLINK="https://cdn.gh-proxy.org/https://github.com/NelloKudo/osu-winello/releases/download/winello-bins/osu-winello-prefix.tar.xz" # Default WINEPREFIX
OSUMIMELINK="https://cdn.gh-proxy.org/https://github.com/NelloKudo/osu-winello/releases/download/winello-bins/osu-mime.tar.gz"          # osu-mime (file associations)
YAWLLINK="https://cdn.gh-proxy.org/https://github.com/whrvt/yawl/releases/download/v${YAWLVERSION}/yawl"                                # yawl (Wine launcher for Steam Runtime)

OSUDOWNLOADURL="https://m1.ppy.sh/r/osu!install.exe"

DISCRPCLINK="https://cdn.gh-proxy.org/https://github.com/EnderIce2/rpc-bridge/releases/download/v${DISCRPCBRIDGEVERSION}/bridge.zip"
GOSUMEMORYLINK="https://cdn.gh-proxy.org/https://github.com/l3lackShark/gosumemory/releases/download/${GOSUMEMORYVERSION}/gosumemory_windows_amd64.zip"
TOSULINK="https://cdn.gh-proxy.org/https://github.com/tosuapp/tosu/releases/download/v${TOSUVERSION}/tosu-windows-v${TOSUVERSION}.zip"
AKATSUKILINK="https://air_conditioning.akatsuki.gg/loader"
MAPPINGTOOLSLINK="https://cdn.gh-proxy.org/https://github.com/OliBomby/Mapping_Tools/releases/download/v${MAPPINGTOOLSVERSION}/mapping_tools_installer_x64.exe"

# The URL for our git repo
WINELLOGIT="https://cdn.gh-proxy.org/https://github.com/NelloKudo/osu-winello.git"
...
deleteFolder() {
    ...
    if [ "$dirchoice" = 'y' ] || [ "$dirchoice" = 'Y' ]; then
        read -r -p "$(Info "您确定吗？这会删除您的osu!文件夹 (y/N)")" dirchoice2
...
reconfigurePrefix() {
    ...
    [ -n "${freshprefix}" ] && {
        ...
        Info "正在与winetricks下载并安装一个新的. 这会花费一些时间，喝杯咖啡或做做其他事情吧."
        "$WINESERVER" -k
