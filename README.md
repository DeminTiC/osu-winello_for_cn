...
whrvt 又名 spectator 在 Wine、Proton 及相关方面的帮助，总能解决任何问题 :')

ThePooN 的 Discord 服务器 从早期阶段就支持 Winello！
...
diamondburned 的 osu-wine

openglfreak 的软件包

EnderIce2 的 rpc-bridge
